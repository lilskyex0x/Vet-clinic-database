...
```sh
  cd my-folder
  git clone https://github.com/lilskyex0x/Vet-clinic-database.git
```
...
Feel free to check the [issues page](https://github.com/lilskyex0x/Vet-clinic-database/issues).
